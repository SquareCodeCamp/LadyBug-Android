...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiHeaders = ((WalletApp) getApplication()).apiHeaders;
        yourService = ((WalletApp) getApplication()).yourService;
    ...
    public void login(String email, String password) {
        ...
        yourService.login(new LogInBody(email, password), new Callback<LogInResponse>() {
            @Override
            ...
            public void failure(RetrofitError error) {
                ...
                onError(error.getBody().toString());
            }
        });
    }
